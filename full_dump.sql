...
--
-- Host: localhost    Database: vehicle-website
-- ------------------------------------------------------
...
CREATE TABLE `advertisement` (
  ...
  `sellerType` int(11) DEFAULT 0,
  `tender` bit(1) DEFAULT b'0',
  ...
  `wheels` varchar(50) DEFAULT '0',
  `amphibious` bit(1) DEFAULT b'0',
  `document` int(11) DEFAULT 0,
  `technical` int(11) DEFAULT 0,
  `constructionType` int(11) DEFAULT 0,
  `brand` varchar(50) DEFAULT NULL,
  `model` varchar(50) DEFAULT '0',
  `status` int(11) DEFAULT 0,
  `creationDate` datetime DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `FK_advertisement_wheel` (`wheel`),
  ...
  KEY `FK_advertisement_technical` (`technical`),
  KEY `FK_advertisement_document` (`document`),
  KEY `FK_advertisement_conditon` (`condition`),
  ...
  CONSTRAINT `FK_advertisement_conditon` FOREIGN KEY (`condition`) REFERENCES `conditon` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_advertisement_construction` FOREIGN KEY (`constructionType`) REFERENCES `construction` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ...
  CONSTRAINT `FK_advertisement_technical` FOREIGN KEY (`technical`) REFERENCES `technical` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ...
  CONSTRAINT `FK_advertisement_wheel` FOREIGN KEY (`wheel`) REFERENCES `wheel` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
(1,2000000.00,'Матвей','79829817369','Красноярск',2,1,0x00,1,'Фиолетовый',239,'Toyota 1nz fe',110,1,1,'1300x500',0x01,1,1,1,'Тундра','Восток',1,'2026-01-14 16:33:41'),
(2,5000000.00,'Матвей','79829817369','Ишим',1,2,0x01,2,'Зеленый',NULL,'ВАЗ 2111',398,2,1,'1400x650',0x01,1,1,2,'Тингер','ТФ4 ПРО',1,'2026-01-14 16:40:31');
...
DROP TABLE IF EXISTS `advertisement_photo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `advertisement_photo` WRITE;
/*!40000 ALTER TABLE `advertisement_photo` DISABLE KEYS */;
set autocommit=0;
INSERT INTO `advertisement_photo` VALUES
...
/*!40000 ALTER TABLE `advertisement_photo` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
set autocommit=0;
INSERT INTO `advertisement_status` VALUES
(1,'Принято'),
(2,'В ожидании');
...
LOCK TABLES `conditon` WRITE;
/*!40000 ALTER TABLE `conditon` DISABLE KEYS */;
set autocommit=0;
INSERT INTO `conditon` VALUES
(1,'Новый'),
(2,'Б/У');
/*!40000 ALTER TABLE `conditon` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Table structure for table `manufacturer_synonym`
--

DROP TABLE IF EXISTS `manufacturer_synonym`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `manufacturer_synonym` (
...
--
-- Dumping data for table `manufacturer_synonym`
--

LOCK TABLES `manufacturer_synonym` WRITE;
/*!40000 ALTER TABLE `manufacturer_synonym` DISABLE KEYS */;
set autocommit=0;
INSERT INTO `manufacturer_synonym` VALUES
(1,'тингер'),
(2,'тундра'),
(12,'трекер'),
(12,'трэкер'),
...
(108,'лось бв'),
(119,'вне дорог');
/*!40000 ALTER TABLE `manufacturer_synonym` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
-- Dump completed on 2026-02-07 17:53:34
